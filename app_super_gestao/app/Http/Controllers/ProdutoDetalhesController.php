...
class ProdutoDetalhesController extends Controller
{
    ...
    {
        ProdutoDetalhes::create($request->all());
        echo 'sucesso';
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ProdutoDetalhes $produto_detalhe)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, ProdutoDetalhes $produto_detalhe)
    {
        $produto_detalhe->update($request->all());
        
        return redirect()->route('produto-detalhes.index');
    }
